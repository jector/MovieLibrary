    ...
    // public property
        ...
        public MovieFile(string movieFilePath)
        {
            ...
            try
            {
                ...
                sr.Close();
                Console.WriteLine("Movies in file {Count}", Movies.Count);
            }
            catch (Exception ex)
            {
        ...
        public bool isUniqueTitle(string title)
        {
            ...
            {
                Console.WriteLine("Duplicate movie title {Title}", title);
                return false;
            }
            return true;
        }
        ...
        public void AddMovie(Movie movie)
        {
            try
            {
                ...
                Movies.Add(movie);
                // log transaction
                Console.WriteLine("Movie id {Id} added", movie.movieId);
            } 
            catch(Exception ex)
            {
                Console.WriteLine(ex.Message);
